...
public class AuditorStatExcluChecklist extends BasePage {
	...
	*/
	...
	void setBrowser() throws InterruptedException, IOException
	{
		...
		test = extent.startTest("Loging In - Auditor (StatutoryExcludingChecklist)");
	...
	void Login() throws InterruptedException, IOException
	{
		...
		initialization(link,5,"StatutoryExcludingChecklist");
	/*	
   ...
   //@Test(priority = 14)
	...
	//	int RiskCritical_NotCompleted = Integer.parseInt(CFOcountPOM.clickRiskCriticalNotCompleted().getText());	//Reading the High Risk value of Not Completed compliance
		...
		Thread.sleep(8000);
		int total = RiskCritical_NotCompleted + RiskCritical_ClosedDelayed + RiskCritical_ClosedTimely + RiskCritical_NotApplicable;				//Calculating the values to match with High value of Labour.
		Thread.sleep(5000);	
		if(IndustrySpeCritical == total)
		{
	  ...
	  //@Test(priority = 59)
		...
		//@Test(priority = 75)
				...
				void DetailedreportVsdashboardNotCompletedcount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsdashboardNotCompletedcountUp(test,"StatutoryExcludingChecklist");
				...
				void DetailedreportVsdashboardCloseddealyedcount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsdashboardCloseddealyedcountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
			...
			//@Test(priority = 81)
				void DetailedreportVsdashboardclosedtimelycount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsdashboardclosedtimelycountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
			...
			// @Test(priority = 82)//19/03/2025
				void DetailedreportVsdashboardNAcount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsdashboardNAcountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
			...
			//@Test(priority = 83)
				void DetailedreportVsOverduecount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsOverduecountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
				...
				void DetailedreportVsDueTodaycount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsDueTodaycountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
				...
				void DetailedreportVsPFRcount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsPFRcountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
				...
				void DetailedreportVsINprocount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsINprocountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
				...
				void DetailedreportVsRejectedcount() throws InterruptedException {
					...
					AuditorcountPOM.DetailedreportVsRejectedcountUp(test,"StatutoryExcludingChecklist");
			        extent.endTest(test);
			        extent.flush();
			    }
				...
				//@Test(priority =88) //20/03/2025
					void DetailedreportVsCommercialCriticalcount() throws InterruptedException {
						...
						AuditorcountPOM.DetailedreportVsCommercialCriticalcount(test,"StatutoryExcludingChecklist");
				        extent.endTest(test);
				        extent.flush();
				    }
					...
					void DetailedreportVsCommercialHighcount() throws InterruptedException {
						...
						AuditorcountPOM.DetailedreportVsCommercialHighcount(test,"StatutoryExcludingChecklist");
				        extent.endTest(test);
				        extent.flush();
				    }
					...
					void DetailedreportVsCommercialMediumcount() throws InterruptedException {
						...
						AuditorcountPOM.DetailedreportVsCommercialMediumcount(test,"StatutoryExcludingChecklist");
				        extent.endTest(test);
				        extent.flush();
				    }
				...
				//	@Test(priority = 91)
					void DetailedreportVsCommercialLowcount() throws InterruptedException {
						...
						AuditorcountPOM.DetailedreportVsCommercialLowcount(test,"StatutoryExcludingChecklist");
				        extent.endTest(test);
				        extent.flush();
				    }
					...
					//@Test(priority = 92)
						void riskSummaryCriticalNotCompleted1() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.riskSummaryCriticalNotCompletedAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void riskSummaryClosedDelayed() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.riskSummaryClosedDelayedAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void riskSummaryClosedTimely() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.riskSummaryClosedTimelyAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void riskSummaryNotApplicable() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.riskSummaryNotApplicableAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void DepartmentSummaryOverdue() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.DepartmentSummaryOverdueAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void DepartmentSummaryClosedDelayed() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.DepartmentSummaryClosedDelayedAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void DepartmentSummaryClosedT() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.DepartmentSummaryClosedTAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void DepartmentSummaPR() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.DepartmentSummaPRAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void DepaINPROGRESSR() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.DepaINPROGRESSRAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void DepartmentSummaryRejected() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.DepaRejectedRAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
						...
						void DepartmentSummaryNotApplicable() throws InterruptedException, IOException
						{
							...
							AuditorcountPOM.DepaNotApplicAU( test, "Critical","StatutoryExcludingChecklist");
							extent.endTest(test);
							extent.flush();
