...
//	public static Web  = null;		//Web instance created
	...
	{
	//	String workingDir = System.getProperty("web.chrome.","C:/March2022/PerformerPom//chrome.exe");
		extent = new com.relevantcodes.extentreports.ExtentReports("D:\\Avacom22Nov\\AvacomUpdated26JULY2023\\Reports\\Auditor.html",true);
...
//	@Test(priority = 15)
	...
	/*	Thread.sleep(500);
		String ClosedTimely = CFOcountPOM.clickFinanceClosedTimely().getText();		//Reading the Closed Timely value of Human Resource
		...
		if(Closed_Timely > 0)
		{
			CFOcountPOM.clickFinanceClosedTimely().click();
			Thread.sleep(500);
