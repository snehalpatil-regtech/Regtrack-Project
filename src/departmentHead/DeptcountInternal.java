...
public class DeptcountInternal extends BasePage  {
...
//	@Test(priority = 3)
	...
	int	count = Integer.parseInt(compliancesCount1);
		...
		elementsList1 = CFOcountPOM.readUserList1();
...
//	@Test(priority = 6)
	void SummaryofOverdueFilter() throws InterruptedException, IOException
	{
		...
		DeptCountPOM.SummaryofOverdueFilterIn( test);
...
//	@Test(priority = 9)
	void NotCompletedPFR_PieChart() throws InterruptedException
	{
		...
		if(NotCompletedValue > 0)
		{
			...
			DeptCountPOM.GraphCountPFRIn( test, "Critical", critical, "Statutory");
			
				Thread.sleep(2000);
			
				DeptCountPOM.GraphCountPFRIn( test, "High", high, "Statutory");
				
				Thread.sleep(2000);
			
				DeptCountPOM.GraphCountPFRIn( test, "Medium", medium, "Statutory");
			
				Thread.sleep(2000);
			
				DeptCountPOM.GraphCountPFRIn( test, "Low", low, "Statutory");
...
//	@Test(priority = 24)
		void NotApplicable_PieChartPeriod() throws InterruptedException
		{
			...
			Thread.sleep(1500);
			int ClosedTimelyValue = Integer.parseInt(CFOcountPOM.clickNotApplicableInternal().getText());	//Reading value of 'After Due Date'
			CFOcountPOM.clickNotApplicableInternal().click();								//CLicking on 'Not Completed' count
