...
public class CertificateOwnerDiyTest extends BasePage{
...
/*	public static XSSFSheet ReadExcel() throws IOException
	{
		...
		sheet = workbook.getSheetAt(23);					//Retrieving third sheet of Workbook
		return sheet;
	}
	*/
	@BeforeTest
	...
	//	test.log(LogStatus.PASS, "Logging into system");
		initialization(link,23,"Statutory");
	/*	XSSFSheet sheet = ReadExcel();
	...
	{
		test = extent.startTest("Certificate Owner - Reopen");
		
		CertificateOwnerMethod.CertificateOwnerReopen(test);
